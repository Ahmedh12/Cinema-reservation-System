...
if (isset($_COOKIE["user"])) {
  ...
  $res = $conn->query("select chair_id , show_times.start_time,show_times.show_date from `reservations`,`movies` ,`show_times` where reservations.room_id = 2 && user_name= '$username' && reservations.movie_id = movies.id && reservations.movie_id = show_times.movie_id && reservations.movie_id= " . $_GET['id']);
