...
<body>
    ...
    <div class="form-container">
        ...
        <div class="field-container">
            <label for="securitycode">Pin</label>
            <input id="securitycode" type="text" pattern="[0-9]*" inputmode="numeric">
        </div>

        <div class="field-container">
            <form action="./reserveSeat.php" method="post">
                <input type="text" id="hall" name="hall" hidden value="<?php echo $hall ?>">
                <input type="text" id="movie" name="movie" hidden value="<?php echo $movie ?>">
                <button type="submit" id="sub">Pay</button>
            </form>
        </div>
    </div>
